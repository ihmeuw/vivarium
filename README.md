[![Build Status](http://costeffect-app-p01.ihme.washington.edu/buildStatus/icon?job=CEAM_Tests/develop)](http://costeffect-app-p01.ihme.washington.edu/job/CEAM_Tests/job/develop/)
