...
class SimulationContext:
    def __init__(
        ...
        self._lifecycle.add_constraint(
            self.add_components, allow_during=["initialization"]
        )
        self._lifecycle.add_constraint(
            self.get_population,
...
class Builder:
    ...
    def __init__(self, configuration, plugin_manager):
        ...
        self.value = plugin_manager.get_plugin_interface(
            "value"
        )  # type: ValuesInterface
        self.event = plugin_manager.get_plugin_interface(
            "event"
        )  # type: EventInterface
        ...
        self.data = plugin_manager.get_plugin_interface(
            "data"
