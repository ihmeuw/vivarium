...
class InterpolatedTable(LookupTable):
    ...
    def __init__(
        ...
        table_number: int,
        data: pd.DataFrame,
        population_view_builder: Callable[[LookupTable, list[str]], PopulationView],
        key_columns: Sequence[str],
        parameter_columns: Sequence[str],
        value_columns: Sequence[str],
        ...
        self.population_view = population_view_builder(self, view_columns)
...
class CategoricalTable(LookupTable):
    ...
    def __init__(
        ...
        self.data = data
        self.population_view = population_view_builder(self, list(self.key_columns))
