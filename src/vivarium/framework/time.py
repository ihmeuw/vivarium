...
from vivarium.types import NumberLike, SimStepSize, SimTime
...
class SimulationClock(Manager):
    ...
    @property
    def minimum_step_size(self) -> SimStepSize:
    ...
    @property
    def standard_step_size(self) -> SimStepSize:
    ...
    @property
    def step_size(self) -> SimStepSize:
    ...
    @property
    def event_time(self) -> SimTime:
        "Convenience method for event time, or clock + step"
        return self.time + self.step_size

    def __init__(self):
        self._clock_time: SimTime = None
        self._stop_time: SimTime = None
        self._minimum_step_size: SimStepSize = None
        self._standard_step_size: SimStepSize = None
        self._clock_step_size: SimStepSize = None
    ...
    def get_active_simulants(self, index: pd.Index, time: SimTime) -> pd.Index:
