...
class Component(ABC):
    ...
    def setup_component(self, builder: "Builder") -> None:
        ...
        Args:
            builder: The builder object used to set up the component.
        """
    ...
    def on_post_setup(self, event: Event) -> None:
        ...
        Args:
            event: The event object associated with the post_setup event.
        """
        pass
    ...
    def on_initialize_simulants(self, pop_data: "SimulantData") -> None:
        ...
        Args:
            pop_data: The data associated with the simulants being initialized.
        """
        pass
    ...
    def on_time_step_prepare(self, event: Event) -> None:
        ...
        Args:
            event: The event object associated with the time_step__prepare event.
        """
        pass
    ...
    def on_time_step(self, event: Event) -> None:
        ...
        Args:
            event: The event object associated with the time_step event.
        """
        pass
    ...
    def on_time_step_cleanup(self, event: Event) -> None:
        ...
        Args:
            event: The event object associated with the time_step__cleanup event.
        """
        pass
    ...
    def on_collect_metrics(self, event: Event) -> None:
        ...
        Args:
            event: The event object associated with the collect_metrics event.
        """
        pass
    ...
    def on_simulation_end(self, event: Event) -> None:
        ...
        Args:
            event: The event object associated with the simulation_end event.
        """
        pass
    ...
    def get_configuration(self, builder: "Builder") -> Optional[LayeredConfigTree]:
        ...
        Args:
            builder: The simulation's builder object.
    ...
    def build_lookup_table(
        ...
        Args:
            builder: The builder object used to set up the component.
            data_source: The data source to build the LookupTable from.
            value_columns: The columns to include in the LookupTable.

        Returns:
            The LookupTable built from the data source.

        Raises:
            ConfigurationError: If the data source is invalid.
        """
    ...
    def _register_post_setup_listener(self, builder: "Builder") -> None:
        ...
        Args:
            builder: The builder with which to register the listener.
        """
    ...
    def _register_simulant_initializer(self, builder: "Builder") -> None:
        ...
        Args:
            builder: The builder with which to register the initializer.
        """
