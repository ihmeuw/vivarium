...
class Level3InterventionScalarizedModule(SimulationModule):
    ...
    def incidence_rates(self, population, rates):
        ...
        #
        # Vectorized version: the multiplication by 1.0 if conditions evaluate to False or by 0.5 if conditions evaluate to True is vectorized
        # (performed on EACH member of the vector "rates").  rates *= 1.0 - ( ((population.year >= 1995) & (population.age >= 25)) * 0.5 )
        #
        return rates
