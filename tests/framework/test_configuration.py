...
from vivarium.framework.configuration import (ConfigurationError, build_simulation_configuration,
                                              build_model_specification, _validate_model_specification_file,
                                              _get_default_specification, DEFAULT_PLUGINS)


def test_get_default_specification():
...
def test_validate_model_specification_failures():
    with pytest.raises(ConfigurationError):
        _validate_model_specification_file('made_up_file.yaml')
    ...
    with pytest.raises(ConfigurationError):
        ...
        _validate_model_specification_file(model_spec)
