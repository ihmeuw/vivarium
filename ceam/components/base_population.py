...
class Mortality:
    def setup(self, builder):
        ...
        self.life_table = builder.lookup(pd.read_csv(os.path.join(j_drive, 'WORK/10_gbd/01_dalynator/02_inputs/YLLs/usable/FINAL_min_pred_ex.csv')), key_columns=('age',), interpolatable_columns=('age',))
